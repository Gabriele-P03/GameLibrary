#include "Vector3f.h"
 ...
 jgl::Vector3f jgl::Vector3f::xAxis = jgl::Vector3f(1.0f, 0.0f, 0.0f);
 jgl::Vector3f jgl::Vector3f::yAxis = jgl::Vector3f(0.0f, 1.0f, 0.0f);
 jgl::Vector3f jgl::Vector3f::zAxis = jgl::Vector3f(0.0f, 0.0f, 1.0f);
...
void jgl::Vector3f::setX(float x){this->x = x;}
void jgl::Vector3f::setY(float y){this->y = y;}
void jgl::Vector3f::setZ(float z){this->z = z;}
void jgl::Vector3f::setAll(float x, float y, float z){this->x = x; this->y = y; this->z = z;}
void jgl::Vector3f::set(Vector3f* vec3f){this->setAll( (*vec3f).x, (*vec3f).y, (*vec3f).z );}

void jgl::Vector3f::addX(float x){this->x += x;}
void jgl::Vector3f::addY(float y){this-> y += y;}
void jgl::Vector3f::addZ(float z){this-> z += z;}

void jgl::Vector3f::add(Vector3f* vec3f){
    this->addX( (*vec3f).x ); 
    this->addY( (*vec3f).y );
    this->addZ( (*vec3f).z );
}

void jgl::Vector3f::addAll(float x, float y, float z){
    this->addX(x);
    this->addY(y);
    this->addZ(z);
}

void jgl::Vector3f::mulX(float x){this->x *= x;}
void jgl::Vector3f::mulY(float y){this->y *= y;}
void jgl::Vector3f::mulZ(float z){this->z *= z;}
void jgl::Vector3f::mul(Vector3f* vec3f){
    this->mulX( (*vec3f).x );
    this->mulY( (*vec3f).y );
    this->mulZ( (*vec3f).z );
}
void jgl::Vector3f::mulAll(float x, float y, float z){this->mulX(x); this->mulY(y); this->mulZ(z);}
...
void jgl::Vector3f::rotate(double _rad, jgl::Vector3f* axis){
...
void jgl::Vector3f::rotateAround(jgl::Vector3f* vec3f, double _rad, jgl::Vector3f* axis){

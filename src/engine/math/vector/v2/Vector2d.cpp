...
jgl::Vector2d* jgl::Vector2d::setX(double x){this->x = x; return this;}
jgl::Vector2d* jgl::Vector2d::setY(double y){this->y = y; return this;}
jgl::Vector2d* jgl::Vector2d::set(Vector2d* vec2d){this->setAll( (*vec2d).x, (*vec2d).y ); return this;}
jgl::Vector2d* jgl::Vector2d::setAll(double x, double y){this->x = x; this->y = y; return this;}



jgl::Vector2d* jgl::Vector2d::addX(double x){this->x += x; return this;}
jgl::Vector2d* jgl::Vector2d::addY(double y){this-> y += y; return this;}
jgl::Vector2d* jgl::Vector2d::add(Vector2d* vec2d){this->addX( (*vec2d).x ); this->addY( (*vec2d).y ); return this;}
jgl::Vector2d* jgl::Vector2d::addAll(double x, double y){this->addX(x); this->addY(y); return this;}



jgl::Vector2d* jgl::Vector2d::mulX(double x){this->x *= x; return this;}
jgl::Vector2d* jgl::Vector2d::mulY(double y){this->y *= y; return this;}
jgl::Vector2d* jgl::Vector2d::mul(Vector2d* vec2d){this->mulX( (*vec2d).x ); this->mulY( (*vec2d).y ); return this;}
jgl::Vector2d* jgl::Vector2d::mulAll(double x, double y){this->mulX(x); this->mulY(y); return this;}
...
jgl::Vector2d* jgl::Vector2d::rotate(double _rad){
...
jgl::Vector2d* jgl::Vector2d::rotateAround(jgl::Vector2d* vec2d, double _rad){
...
jgl::Matrix3d* jgl::Vector2d::getRotationMatrix(){
    return new jgl::Matrix3d(this->angleRad(&jgl::Vector2d::xAxis));
}
jgl::Matrix3d* jgl::Vector2d::getTranslationMatrix(){

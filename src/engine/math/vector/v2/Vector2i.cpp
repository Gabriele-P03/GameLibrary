...
jgl::Vector2i* jgl::Vector2i::setX(int x){this->x = x; return this;}
jgl::Vector2i* jgl::Vector2i::setY(int y){this->y = y; return this;}
jgl::Vector2i* jgl::Vector2i::set(Vector2i* vec2i){this->setAll( (*vec2i).x, (*vec2i).y ); return this;}
jgl::Vector2i* jgl::Vector2i::setAll(int x, int y){this->x = x; this->y = y; return this;}



jgl::Vector2i* jgl::Vector2i::addX(int x){this->x += x; return this;}
jgl::Vector2i* jgl::Vector2i::addY(int y){this-> y += y; return this;}
jgl::Vector2i* jgl::Vector2i::add(Vector2i* vec2i){this->addX( (*vec2i).x ); this->addY( (*vec2i).y ); return this;}
jgl::Vector2i* jgl::Vector2i::addAll(int x, int y){this->addX(x); this->addY(y); return this;}



jgl::Vector2i* jgl::Vector2i::mulX(int x){this->x *= x; return this;}
jgl::Vector2i* jgl::Vector2i::mulY(int y){this->y *= y; return this;}
jgl::Vector2i* jgl::Vector2i::mul(Vector2i* vec2i){this->mulX( (*vec2i).x ); this->mulY( (*vec2i).y ); return this;}
jgl::Vector2i* jgl::Vector2i::mulAll(int x, int y){this->mulX(x); this->mulY(y); return this;}

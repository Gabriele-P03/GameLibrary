...
void jgl::Vector2f::setX(float x){this->x = x;}
void jgl::Vector2f::setY(float y){this->y = y;}
void jgl::Vector2f::set(Vector2f* vec2f){this->setAll( (*vec2f).x, (*vec2f).y );}
void jgl::Vector2f::setAll(float x, float y){this->x = x; this->y = y;}


void jgl::Vector2f::addX(float x){this->x += x;}
void jgl::Vector2f::addY(float y){this-> y += y;}
void jgl::Vector2f::add(Vector2f* vec2f){this->addX( (*vec2f).x ); this->addY( (*vec2f).y );}
void jgl::Vector2f::addAll(float x, float y){this->addX(x); this->addY(y);}

void jgl::Vector2f::mulX(float x){this->x *= x;}
void jgl::Vector2f::mulY(float y){this->y *= y;}
void jgl::Vector2f::mul(Vector2f* vec2f){this->mulX( (*vec2f).x ); this->mulY( (*vec2f).y );}
void jgl::Vector2f::mulAll(float x, float y){this->mulX(x); this->mulY(y);}
...
void jgl::Vector2f::rotate(double _rad){
...
void jgl::Vector2f::rotateAround(jgl::Vector2f* vec2f, double _rad){
...
std::string* jgl::Vector2f::toString(){  
 ...
 jgl::Vector2f jgl::Vector2f::xAxis = jgl::Vector2f(1.0f, 0.0f);
 jgl::Vector2f jgl::Vector2f::yAxis = jgl::Vector2f(1.0f, 0.0f);
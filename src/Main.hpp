...
#include "engine/scene/testScene.hpp"
#include "engine/input/mouse/MouseInput.h"
...
inline void createWindow(int w, int h, const char* title, GLFWmonitor* monitor, GLFWwindow* share, 
    ...
    */
    ...
    std::cout<<"Done\nSetting Characters Callback...";
    glfwSetCharCallback(glfwGetCurrentContext(), jpl::character_callback);
    std::cout<<"Done\nSetting Mouse Button Callback...";
    glfwSetMouseButtonCallback(glfwGetCurrentContext(), jpl::mouse_button_callback);
